...
const TipEditModal = ({ user, initialTip, onClose, onSave }) => {
  ...
  const inputCls =
    'w-full p-4 border-2 border-[var(--border)] rounded-2xl font-bold bg-[var(--bg)] text-[var(--text)] placeholder-[var(--text-dim)] focus:border-red-600 outline-none';
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-[3rem] w-full max-w-2xl max-h-[92vh] overflow-y-auto p-8 relative">
        ...
        <div className="space-y-5 text-left">
          ...
          <div className="space-y-1">
            ...
            <input
              placeholder="Np. Klasyfikacja mięsa wieprzowego"
              className={inputCls}
              value={form.title}
        ...
        <button
          ...
          className={`w-full mt-6 py-5 rounded-3xl font-black uppercase tracking-widest shadow-2xl transition-all ${
            form.title.trim()
