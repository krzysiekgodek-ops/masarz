          ...
          <div className="flex items-center justify-between">
            ...
            {!showAdForm && (
              <button onClick={openNewAdForm}
                className="flex items-center gap-2 px-5 py-3 bg-[#DC2626] text-white rounded-2xl text-xs font-black uppercase hover:bg-red-700 transition-all shadow-lg">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-[10px] text-[var(--text-dim)] mb-1">
                          ...
                          {ad.targetUrl && (
                            <span className="flex items-center gap-1">
                              {isPdf ? <FileText size={9} /> : <ExternalLink size={9} />}
                              <span className="truncate max-w-[120px]">{ad.targetUrl}</span>
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {adSubTab === 'archive' ? (
                          <button
                            onClick={() => updateDoc(doc(db, 'ads', ad.id), { archived: false, active: true, endDate: null })}
                          ...
                          <>
                            ...
                            <button onClick={() => deleteDoc(doc(db, 'ads', ad.id))}
                              className="p-2.5 bg-red-900/20 text-red-400 rounded-xl hover:bg-red-600 hover:text-white transition-all" title="Usuń">
                              <Trash2 size={13} />
                            </button>
                          </>
                        )}
