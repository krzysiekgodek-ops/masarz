...
// Wyciąga czysty tekst z HTML do podglądu
    ...
    <div>
      ...
      <div className="flex items-center justify-between px-4 pt-5 pb-3">
        ...
        {userProfile?.isAdmin && (
          <button
            onClick={onAddTip}
            className="flex items-center gap-2 px-4 py-2.5 bg-red-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-red-900/30 active:scale-95 transition-all"
          >
            <Plus size={14} /> Dodaj
          </button>
        )}
                ...
                <div className="flex gap-0">
                  ...
                  <div className={`flex-1 p-3.5 ${!tip.imageUrl ? 'pl-4' : ''}`}>
                    <div className="flex items-center gap-1.5 mb-1">
                      <Lightbulb size={11} className="text-amber-500 flex-none" />
